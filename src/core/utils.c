...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "core.utils",
        "sources": [
            "C:\\EasyGelAlyzer\\src\\core\\utils.py"
        ]
    },
...
#define __PYX_HAVE__core__utils
#define __PYX_HAVE_API__core__utils
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "core.utils" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "core.utils"
extern int __pyx_module_is_main_core__utils;
int __pyx_module_is_main_core__utils = 0;

/* Implementation of "core.utils" */
...
#define __pyx_n_u_ __pyx_string_tab[1]
...
__Pyx_RefNannySetupContext("PyInit_utils", 0);
  ...
  if (__pyx_module_is_main_core__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "core.utils")) {
      if (unlikely((PyDict_SetItemString(modules, "core.utils", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init core.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init core.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{18},{6},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (71 bytes) */
const char* const cstring = "x\332%\210\313\r\2000\014\305\366a\tFy\ni\220*\362Qi\262?\005|\261\345}c\355.\350\216\274\211\345 \2768\314\302\001\243u\027\026\255T\336r\262\317\243H\377\236\222MN*M e&\360\000:\330 \260";
    PyObject *data = __Pyx_DecompressString(cstring, 71, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (82 bytes) */
const char* const bytes = "?*cline_in_tracebackcommon__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
