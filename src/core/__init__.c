...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "core.__init__",
        "sources": [
            "C:\\EasyGelAlyzer\\src\\core\\__init__.py"
        ]
    },
...
#define __Pyx_MODULE_NAME "core.__init__"
extern int __pyx_module_is_main_core____init__;
int __pyx_module_is_main_core____init__ = 0;
...
#define __pyx_kp_u_core___init __pyx_string_tab[1]
...
__Pyx_RefNannySetupContext("PyInit_core", 0);
  ...
  if (__pyx_module_is_main_core____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_core___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    ...
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (74 bytes) */
const char* const cstring = "(\265/\375 X\r\002\000\"\005\016\020\260k\014\"\006\212\010|U+\305\244\301\032&@\277\014\367\367\264+H\026\331\271\246\376\021\235\376\343i$\241\177\315Co\306\t\034\267v\315Q\363\214\337\324|\200+\215\020\001\000\300\207\022\005";
    PyObject *data = __Pyx_DecompressString(cstring, 74, 3);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (75 bytes) */
const char* const cstring = "x\332%\314\301\r\2000\014\003\300\215X\201Q\254\220\032)\"mE\233\356O\000\177|\376x\327>\270\001\326,\000ukL#\206(\017\321\013\250\222;S{Y\316WM\352\327\367\022\377=\031\205\247,\317\217\340\014\340\001\003\342#\004";
    PyObject *data = __Pyx_DecompressString(cstring, 75, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
...
const char* const bytes = "?core.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
