...
python -m PyInstaller --onefile --windowed --name EasyGelAlyzer %ICON_OPT% --paths "%~dp0src" --add-data "%~dp0src\assets;assets" --hidden-import i18n --hidden-import i18n.translations --hidden-import ui --hidden-import ui.main_window --hidden-import ui.dialogs --hidden-import ui.preset_manager --hidden-import core --hidden-import core.annotation --hidden-import core.calibration --hidden-import core.excel_export --hidden-import core.image_export --hidden-import core.image_manager --hidden-import core.image_proc --hidden-import core.marker_presets --hidden-import core.project_io --hidden-import core.utils --hidden-import matplotlib.backends.backend_svg --hidden-import matplotlib.backends.backend_pdf --workpath "%WORK_PATH%" --distpath "%DIST_PATH%" --specpath "%SPEC_PATH%" "%~dp0src\main.py"
